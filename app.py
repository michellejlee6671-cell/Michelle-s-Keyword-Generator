...
DB = {
    "역삼 (강남권)": ["강남역", "역삼역", "GFC", "센터필드", "GS타워", "차병원", "교대역", "삼성역"],
    "한남 (용산권)": ["나인원한남", "유엔빌리지", "순천향대병원", "블루스퀘어", "리움미술관", "이태원", "용산역"],
    "수원 (행궁동)": ["화성행궁", "수원역", "행리단길", "통닭거리", "수원시청", "팔달문", "장안문"],
    "마곡 (강서권)": ["마곡나루역", "마곡역", "서울식물원", "LG아트센터", "발산역", "코엑스마곡"]
}

# 3. 마케팅 수식어 및 메뉴 로직
themes = ["가성비", "청첩장모임", "분위기좋은", "회식하기좋은", "내돈내산", "찐맛집", "부모님식사", "데이트코스"]
menus = ["솥밥", "스테이크솥밥", "장어솥밥", "한정식", "점심", "저녁", "히츠마부시", "룸식당"]
suffixes = ["맛집", "추천", "식당", "추천맛집", "추천식당"]
...
with col2:
    selected_themes = st.multiselect("적용할 마케팅 테마", themes, default=themes[:5])

with col3:
    selected_menus = st.multiselect("대표 메뉴/업종", menus, default=menus[:4])
