...
DB = {
    "연희시오 야탑점": [
        "성남시", "야탑", "정자동", "분당구", "경기도 성남시", 
        "야탑1동", "경기도 성남시 분당구 정자동", "야탑2동", 
        "경기도 성남시 분당구", "야탑동", "경기도 성남시 분당구 이매동", 
        "경기도 성남시 분당구 서현동", "경기도 성남시 분당구 수내동", 
        "야탑역", "이매역", "서현역", "수내역", "판교역", 
        "모란역", "태평역", "수진역"
    ],
    "역삼 (강남권)": ["강남역", "역삼역", "GFC", "센터필드", "GS타워", "차병원", "교대역", "삼성역", "지에스타워", "신세계강남"],
    "한남 (용산권)": ["나인원한남", "유엔빌리지", "순천향대병원", "블루스퀘어", "리움미술관", "이태원", "용산역", "몬드리안서울"],
